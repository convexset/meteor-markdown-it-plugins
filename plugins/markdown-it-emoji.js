...
//////////////////////////////////////////////////////////////////////////////
var emoji_html = function emoji_html(tokens, idx /*, options, env */) {
...
//////////////////////////////////////////////////////////////////////////////
var emoji_replace = function create_rule(md, emojies, shortcuts, compiledRE) {
...
_MarkdownItPlugins['markdown-it-emoji'] = {
  plugin: function emoji_plugin(md, options) {  
    var opts = normalize_opts(md.utils.assign({}, defaultOptions, options || {}));
