...
function modifyTokenPlugin(md, modifyFn) {
	modifyFn = (Object.prototype.toString.call(modifyFn) === "[object Function]") ? modifyFn : noop;
...
_MarkdownItPlugins['markdown-it-modify-token-modified'] = {
