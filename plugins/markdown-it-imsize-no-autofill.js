...
var parseImageSize = (function() {
  ...
  return function parseImageSize(str, pos, max) {
    var code,
    result = {
      ok: false,
      pos: 0,
...
_MarkdownItPlugins['markdown-it-imsize-no-autofill'] = {
  plugin: function imsize_plugin(md, options) {
    md.inline.ruler.before('emphasis', 'image', image_with_size(md, options));
  }
};
